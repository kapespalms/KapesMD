  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "speaking-navy": {
          DEFAULT: "var(--speaking-navy)",
          foreground: "var(--speaking-navy-foreground)",
        },
        "speaking-green": {
          DEFAULT: "var(--speaking-green)",
          foreground: "var(--speaking-green-foreground)",
        },
        "speaking-blue": {
          DEFAULT: "var(--speaking-blue)",
          foreground: "var(--speaking-blue-foreground)",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
